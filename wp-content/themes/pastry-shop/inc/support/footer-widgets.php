 ...
 * @since 1.0.0
 */
class Pastry_Shop_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'pastry_shop';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'pastry-shop' ), $i ),
...
// Initialize.
$Pastry_Shop_Footer_Widgets = new Pastry_Shop_Footer_Widgets();