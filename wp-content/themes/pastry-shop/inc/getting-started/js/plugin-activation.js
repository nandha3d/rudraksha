jQuery(document).ready(function($) {
    'use strict';
    var this_obj = pastry_shop_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.pastry-shop-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message pastry-shop-plugin-install');
                button.addClass('button-primary pastry-shop-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.pastry-shop-recommended-plugins .pastry-shop-activation-note').css('display','block');
    ...
    $(document).on('click', '.pastry-shop-plugin-activate', function(event) {
