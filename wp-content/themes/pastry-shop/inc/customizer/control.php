 ...
 */
class Pastry_Shop_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'pastry-shop' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'pastry-shop-customize-controls' );
		wp_enqueue_script( 'pastry-shop-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Pastry_Shop_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
