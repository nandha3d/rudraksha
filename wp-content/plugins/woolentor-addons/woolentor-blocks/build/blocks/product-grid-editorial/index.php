<?php
/**
 * Product Grid Editorial Block - Server-side Rendering
...
$grid_settings = [
	// Core settings
	'style'                 => 'editorial',
	'widget_name'           => 'woolentor-product-grid-editorial',
...
$grid_settings = apply_filters( 'woolentor_product_grid_editorial_block_settings', $merge_settings, $settings );
