        ...
        $settings = array(
            ...
            'woolentor_gutenberg_tabs' => array(
                ...
                array(
                    ...
                    'type'    => 'element',
                    'default' => 'on',
                    'documentation' => esc_url('https://woolentor.com/doc/how-to-use-product-grid-luxury-widget-for-elementor-build-a-premium-editorial-style-woocommerce-shop-grid/'),
                    'badge'   => [
                        'is_active' => true,
                        'type'      => 'new',
                        'label'     => esc_html__('New','woolentor')
